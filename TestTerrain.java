...
public class TestTerrain {
	...
	public static void main(String[] args) {
		...
		Ressource e1 = new Ressource("Elixir",5);
		...
		Ressource e2 = new Ressource("Gobelin",4);
		...
		if (t.setCase(4,1,new Ressource("Gobelin",3)))
			System.out.println("Ajout de " +t.getCase(4,1)+ " valide !"); //Test
		else
			System.out.println("Ajout incorrect: problème de coordonnées !");
